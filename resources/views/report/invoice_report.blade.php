    ...
    <div class="card mg-b-20">
      <div class="card-header pb-0">
        <form action="{{ route('search_invoices') }}" method="POST" role="search" autocomplete="off">
          ...
          <div class="col-lg-3">
            <label class="rdiobox">
              <input type="radio" name="radio" value="1" id="type_div" checked> <span>بحث بنوع الفاتورة</span></label>
          </div>
          <div class="col-lg-3 mg-t-20 mg-lg-t-0">
            <label class="rdiobox">
              <input type="radio" name="radio" value="2"><span>بحث برقم الفاتورة</span></label>
          </div><br><br>
          ...
          <div class="row">
            ...
            <div class="col-lg-3" id="start_at">
              ...
              <div class="input-group">
                ...
                </div><input class="form-control fc-datepicker" value="{{ $start ?? '' }}" name="start_at"
            ...
            <div class="col-lg-3" id="end_at">
              ...
              <div class="input-group">
                ...
                </div><input class="form-control fc-datepicker" name="end_at" value="{{ $end ?? '' }}"
                  placeholder="YYYY-MM-DD" type="text">
              </div><!-- input-group -->
            </div>
          </div><br>
