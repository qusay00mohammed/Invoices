    ...
    <ul class="side-menu">
      ...
      <li class="slide">
        ...
        <ul class="slide-menu">
          ...
          <li><a class="slide-item" href="{{ route('unpaid_invoices') }}">الفواتير الغير مدفوعة</a>
          </li>
          <li><a class="slide-item" href="{{ route('partPaid_invoices') }}">الفواتير المدفوعة جزئيا</a>
          </li>
      ...
      <li class="slide">
        ...
        <ul class="slide-menu">
          <li><a class="slide-item" href="{{ route('permissions.index') }}">صلحيات المستخدمين</a></li>
