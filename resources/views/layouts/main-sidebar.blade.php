  ...
  <div class="main-sidemenu">
    <div class="app-sidebar__user clearfix">
      <div class="dropdown user-pro-body">
        <div class="">
          <img alt="user-img" class="avatar avatar-xl brround" src="{{ URL::asset('assets/img/faces/afatar.png') }}"><span
    ...
    <ul class="side-menu">
      ...
      @canany('قائمة الفواتير', 'الفواتير المدفوعة', 'الفواتير الغير مدفوعة', 'الفواتير المدفوعة جزئيا', 'الفواتير المؤرشفة')
      ...
      <li class="slide">
        ...
        <ul class="slide-menu">
          ...
          <li><a class="slide-item" href="{{ route('partPaid_invoices') }}">الفواتير المدفوعة جزئيا</a></li>
          @endcan
          @can('الفواتير المؤرشفة')
          <li><a class="slide-item" href="{{ route('archive_invoices') }}">الفواتير المؤرشفة</a></li>
          @endcan
        </ul>
      </li>
      @endcanany
      @canany(['تقارير العملاء', 'تقارير الفواتير'])
      ...
      @canany(['صلاحيات المستخدمين', 'وظائف المستخدمين', 'قائمة المستخدمين'])
      ...
      <li class="slide">
        ...
        <ul class="slide-menu">
          ...
          <li><a class="slide-item" href="{{ route('permissions.index') }}">صلاحيات المستخدمين</a></li>
          @endcan
          @can('وظائف المستخدمين')
          <li><a class="slide-item" href="{{ route('roles.index') }}">وظائف المستخدمين</a></li>
          @endcan
