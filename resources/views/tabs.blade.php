      ...
      <div class="card-body">
        ...
        <div class="text-wrap">
              ...
              <div class="panel-body tabs-menu-body main-content-body-right border-top-0 border">
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="tab2">
                    <p>dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et
                    ...
                    <p>Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis
                      est eligendi optio cumque nihil impedit quo minus id quod maxime</p>
                  ...
                  <div class="tab-pane" id="tab3">
                    ...
                    <p class="mb-0">similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et
          ...
          <ul class="nav nav-tabs html-source" id="html-source-code" role="tablist">
            <li class="nav-item">
              <a class="nav-link active ml-1 html-code" id="html-code" data-toggle="tab" href="#html-code" role="tab"
                aria-controls="html-code" aria-selected="true"><i class="fab fa-html5 text-orange ml-2"></i>HTML</a>
            </li>
          </ul>
          <!-- Prism Code -->
      ...
      <div class="card-body">
        ...
        <div class="text-wrap">
          ...
          <ul class="nav nav-tabs html-source" id="html-source-code2" role="tablist">
            <li class="nav-item">
              <a class="nav-link active ml-1 html-code" id="html-code2" data-toggle="tab" href="#html-code2" role="tab"
                aria-controls="html-code2" aria-selected="true"><i class="fab fa-html5 text-orange ml-2"></i>HTML</a>
            </li>
          </ul>
          <!---Prism Pre code-->
      ...
      <div class="card-body">
        ...
        <div class="text-wrap">
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="tab11">
                    <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum
                      ...
                      provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum
                      fuga.</p>
                    <p class="mb-0">Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum
                      soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere
                      possimus, omnis voluptas assumenda est, omnis dolor repellendus. </p>
                  </div>
                  ...
                  <div class="tab-pane" id="tab14">
                    ...
                    <p class="mb-0">Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo
                      minus id quod maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor
                      repellendus. Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus </p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <ul class="nav nav-tabs html-source" id="html-source-code3" role="tablist">
            <li class="nav-item">
              <a class="nav-link active ml-1 html-code" id="html-code3" data-toggle="tab" href="#html-code3" role="tab"
                aria-controls="html-code3" aria-selected="true"><i class="fab fa-html5 text-orange ml-2"></i>HTML</a>
            </li>
          </ul>
          <!---Prism Pre code-->
      ...
      <div class="card-body">
        ...
        <div class="text-wrap">
                  ...
                  <div class="tab-menu-heading">
                    <div class="tabs-menu ">
                      ...
                      <ul class="nav panel-tabs ml-3">
                        <li class=""><a href="#tab21" class="active" data-toggle="tab"><i class="fa fa-laptop"></i> Tab
                            Style 01</a></li>
                ...
                <div class="panel-body tabs-menu-body">
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab23">
                      <p>Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et
                        voluptates repudiandae sint et molestiae non recusandae quod maxime placeat facere possimus,
                    ...
                    <div class="tab-pane" id="tab24">
                      <p>On the other hand, we denounce with righteous indignation and dislike men who are so beguiled
                        and demoralized by the charms of pleasure of the moment, so blinded by desire quod maxime
          ...
          <ul class="nav nav-tabs html-source" id="html-source-code4" role="tablist">
            <li class="nav-item">
              <a class="nav-link active ml-1 html-code" id="html-code4" data-toggle="tab" href="#html-code4" role="tab"
                aria-controls="html-code4" aria-selected="true"><i class="fab fa-html5 text-orange ml-2"></i>HTML</a>
            </li>
          </ul>
    ...
    <div class="card-body">
      ...
      <div class="text-wrap">
              ...
              <div class="content_wrapper">
                ...
                <div class="tab_content">
                  <p> On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and
                    ...
                    is untrammelled and when nothing prevents .</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <ul class="nav nav-tabs html-source" id="html-source-code5" role="tablist">
          <li class="nav-item">
            <a class="nav-link active ml-1 html-code" id="js-tab" data-toggle="tab" href="#default-tab" role="tab"
              aria-controls="default-tab" aria-selected="true"><i class="fab fa-html5 text-orange ml-2"></i>HTML</a>
            <a class="nav-link mr-1 html-code" id="js-tab1" data-toggle="tab" href="#default-tab1" role="tab"
              aria-controls="default-tab1" aria-selected="true"><i class="fab fa-node-js text-info mr-2"></i>JS</a>
            <a class="nav-link mr-1 html-code" id="js-tab2" data-toggle="tab" href="#default-tab2" role="tab"
              aria-controls="default-tab2" aria-selected="true"><i class="fab fa-node-js text-info mr-2"></i>JS</a>
          </li>
        </ul>
