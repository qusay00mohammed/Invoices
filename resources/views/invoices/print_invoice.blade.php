					...
					<div class="col-md-12 col-xl-12">
						<div class=" main-content-body-invoice" id="print">
								...
								<div class="card-body">
									...
									<div class="row mg-t-20">
										...
										<div class="col-md">
											...
											<p class="invoice-info-row"><span>رقم الفاتورة</span> <span>{{ $invoice->invoice_num }}</span></p>
										...
										<table class="table table-invoice border text-md-nowrap mb-0">
											...
											<tbody>
												<tr>
													...
													<td class="tx-center">{{ number_format($invoice->amount_collection, 1) }}</td>
													<td class="tx-right">{{ number_format($invoice->amount_commission, 1) }}</td>
                          @php
                          ...
                          @endphp
									...
									<hr class="mg-b-40">
									<a href="#" class="btn btn-danger float-left mt-3 mr-2" id="print_button" onclick="print_invoice()">
